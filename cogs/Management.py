...
class Management(commands.Cog):
    ...
    async def cog_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingPermissions):
            return await ctx.send("Ay!? (You don't have proper permission to use this!? Sorry I can't let you use this command..)")

        if isinstance(error, commands.BotMissingPermissions):
            return await ctx.send("Ay!? (**I** don't have proper permission to use this!? Sorry I can't let myself use this command..)")
