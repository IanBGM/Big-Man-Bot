...
class Management(commands.Cog):
    ...
    async def cog_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.BotMissingPermissions):
            return await ctx.send(f"Ay!? (**I** don't have proper permission to use this!? Sorry I can't let myself use this command.. I feel like I require `{error.missing_permissions}`..?)")
